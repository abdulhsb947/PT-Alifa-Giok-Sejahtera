...
<div class="max-w-3xl mx-auto py-8 space-y-6">
    ...
    {{-- JUDUL --}}
    <div>
        <h1 class="text-3xl font-bold">Pengaturan Direktur</h1>
        <p class="text-gray-500">Kelola informasi akun direktur</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <form method="POST" action="{{ route('direktur.profile.update') }}" enctype="multipart/form-data">
            @csrf
    ...
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <form method="POST" action="{{ route('direktur.password.update') }}">
            @csrf
